...
| 11d | **Refresh token** | ✅ перевыпущен 2026-07-19 **после** публикации | ✅ проверен вызовом API (HTTP 200) | ✅ |
| 11e | **Publishing status → In production** | ✅ опубликовано 2026-07-19 | Токен перевыпущен и проверён — 7-дневный лимит снят | ✅ |
