...
- **Authoritative path**: `/home/ssf/Documents/Github/growth` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/growth.git`, branch `main`.
...
3. This repo, in order: `BUSINESS.md` `SYSTEM.md` `AGENTS.md` `TASKS.md` `STATE.json` `CLAUDE.md`
